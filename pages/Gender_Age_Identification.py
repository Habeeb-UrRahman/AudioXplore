...
gender_model = tf.keras.models.load_model('other_models/gender_classification_model.h5')
male_age_model = tf.keras.models.load_model('other_models/male_age_model.h5')
female_age_model = tf.keras.models.load_model('other_models/female_age_model.h5')
